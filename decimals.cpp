...
int main() {
    ...
    while (true) {
        try {
            std::cout << "Please enter a number you want to round: ";
            std::cin >> userInput;
            userNum = std::stof(userInput);
            std::cout << "Enter how many decimal places you want to round your"
                      << " number to: ";
            std::cin >> decInput;
            ...
            std::cout << "Please enter a number for both values, try again."
                      << std::endl;
        }
    }
